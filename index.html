...
<html lang="en">
  ...
  <body>
    <header>
      ...
      <nav>
        <ul>
          <li style="border-right: 2px solid gray; line-height: 30px;"><a href="https://www.linkedin.com/in/soumya-sekhar-pradhan-814786197/" target="_blank">ABOUT THE CREATOR</a></li>
          <li>&nbsp;&nbsp;IT'S AUTO-UPDATED!!!</li>
        </ul>
      </nav>
    </header>
    ...
    <footer>
      <div class="footer-container">
        <div class="copyright">
          <p>Copyright © 2021 | Soumya Sekhar Pradhan</p>
        </div>
      </div>
    </footer>
